...
$sql="update  tblbooks set BookName=:bookname,CatId=:category,AuthorId=:author,ISBNNumber=:isbn,BookQuintity=:quintity where id=:bookid";
$query = $dbh->prepare($sql);
$query->bindParam(':bookname',$bookname,PDO::PARAM_STR);
$query->bindParam(':category',$category,PDO::PARAM_STR);
$query->bindParam(':author',$author,PDO::PARAM_STR);
$query->bindParam(':isbn',$isbn,PDO::PARAM_STR);
$query->bindParam(':quintity',$quintity,PDO::PARAM_STR);
...
<p class="help-block">An ISBN is an International Standard Book Number.ISBN Must be unique</p>
 ...
 <div class="form-group">
 <label>Quintity<span style="color:red;">*</span></label>
 <input class="form-control" type="text" name="quintity" value="<?php echo htmlentities($result->BookQuintity);?>"   required="required" />
 </div>
 <?php }} ?>
